...
class vehicularNetworkEnvConfig:
    ...
    task_maximum_computation_cycles: float = 25 # CPU cycles for processing 1-Byte of data
    ...
    edge_maximum_computing_cycles: float = 5.0 * 1e9 # 4 GHz
    ...
    """Vehicle related."""
    vehicle_number: Optional[int] = 90 
